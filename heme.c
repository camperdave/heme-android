...
static const char heme_version[] = "0.4.2-android";
...
static void show_helpwin()
{
	...
	mvwprintw(w_help, 7, 1, format, "!", "move 1 page up");
	mvwprintw(w_help, 8, 1, format, "#", "move 1 page down");
	mvwprintw(w_help, 9, 1, format, "(", "move to beginning of file");
	mvwprintw(w_help, 10, 1, format, ")", "move to end of file");
	...
	mvwprintw(w_help, 16, 1, format, "@", "toggle between hex and ascii editing modes");
	mvwprintw(w_help, 17, 1, format, "u", "undo");
	mvwprintw(w_help, 18, 1, format, "s", "save file");
	mvwprintw(w_help, 19, 1, format, "backspace", "quit");
...
static void read_config()
{
	...
	if(config_file == NULL)
	{
		...
		if(pw == NULL)
			return;
		sprintf(cfg_file, "%s/.hemerc");
		*/

		config_file = "/etc/.hemerc";
